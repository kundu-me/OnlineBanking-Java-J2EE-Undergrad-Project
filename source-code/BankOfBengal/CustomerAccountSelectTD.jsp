...
<title>Transaction Details||Bank Of Bengal</title>
...
function updatepage(str)
{
	...
	if(str!=str1)
	{
		...
		var l=acc.length;
		var n=0;
		var selectElement=document.getElementById("td_accountno");
		for (n=0; n<l-1; n++)
		{
  ...
  <section class="container">
    <div class="login">
      <h1>Select Account For Last 3 transaction Details</h1>
      <form method="post" action="CustomerAccountSelectTDServlet" name="account">
      <table>
      	<tr>
      		<td width="150">
      		...
      		<select name="td_accountno" id="td_accountno">
