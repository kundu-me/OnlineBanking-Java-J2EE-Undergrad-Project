...
<title>BranchWise Transaction Statement||Bank Of Bengal</title>
...
function getBranch()
{
  ...
  <section class="container">
    <div class="login">
      <h1>Select Branch And Period For BranchWise Transaction Statement</h1>
      <form method="post" action="AdminTSBranchSelectServlet" name="form1">
      <table>
      <tr>
      		<td>
