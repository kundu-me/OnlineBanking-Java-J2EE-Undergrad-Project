...
function loadFunctions()
{
	...
	xmlhttpPost("AdminVerifyMoneyTransferBeforeAccountCloseAjax.jsp");	
}
function openTransferWindow(tid)
{
	document.getElementById("tidSession").value=tid;
	var branchWindow=window.open("AdminVerifyMoneyTransferWindow.jsp","getBranchWindow","width=950,height=600");
}
...
<tr>
	...
	<button type="button" id="refresh" onclick='xmlhttpPost("AdminVerifyMoneyTransferBeforeAccountCloseAjax.jsp")'>Refresh</button>
	</td>
</tr>
