...
function getSecurityQuestion()
{
  ...
  <section class="container">
    <div class="login">
      ...
      <form method="post" action="ChangeDefaultPasswordServlet">
      <table>
      <tr>
      <td width="150">
      <p><h4>Username</h4></p>
      ...
      <label style="color:red;">*Password Must Contain A Capital Letter, A Small Letter, A Special Character !@#$%^&*</label>
		...
		<tr>
      <td width="150">
      <p><h4>Two-Step Verification</h4></p>
      </td>
      <td>
      <input type="radio" name="twostepverification" id="twostepverificationE" value="on" >Enable
      <input type="radio" name="twostepverification" id="twostepverificationD" value="ff" checked="checked">Disable
      </td>
      </tr>
		</table>       
