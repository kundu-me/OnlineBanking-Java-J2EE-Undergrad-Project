...
<body onload='xmlhttpPost("CustomerTransactionStatementAjax.jsp")'>
...
<tr>
	<th colspan="7" style="text-decoration: underline; height: 50px ">Transaction Details For :<%=(String)session.getAttribute("TSaccountnoSession") %>
	</th>
</tr>
