...
<title>Transaction Statement||Bank Of Bengal</title>
...
function updatepage(str)
{
	...
	if(str!=str1)
	{
		...
		var l=acc.length;
		var n=0;
		var selectElement=document.getElementById("ts_accountno");
		for (n=0; n<l-1; n++)
		{
  ...
  <section class="container">
    <div class="login">
      <h1>Select Account For Transaction Statement</h1>
      <form method="post" action="CustomerAccountSelectTSServlet" name="account">
      <table>
      	<tr>
      		<td width="150">
      		...
      		<select name="ts_accountno" id="ts_accountno">
