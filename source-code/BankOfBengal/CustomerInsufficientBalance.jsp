...
<title>Transfer Money Failure</title>
    ...
    <div class="login">
      ...
      <td colspan="2">&nbsp;
      	...
      	<tr>
      		...
      		<p><h2 style="font-family: Gregoria;">Money Transfer Unsuccessful Message</h2></p>
      		</td>
        </tr>
      <tr>
      		<td>
      		<p><h3 style="font-family: Gregoria;">Transaction Failure</h3></p>
      		</td>
      		<td>
      		<td>
      		<p><h3 style="font-family: Gregoria;">Due To Insufficient Balance</h3></p>
      		</td>
      </tr>
      <tr>
      <td colspan="2">&nbsp;
