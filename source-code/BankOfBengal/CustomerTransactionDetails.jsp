...
<body onload='xmlhttpPost("CustomerTransactionDetailsAjax.jsp")'>
...
<center>
<table class="CSSFormCustomer" align="center" id="transactionDetailsTable">
<tr>
	<th colspan="7" style="text-decoration: underline;height: 50px ">Transaction Details For :<%=(String)session.getAttribute("TDaccountnoSession") %>
	</th>
</tr>
